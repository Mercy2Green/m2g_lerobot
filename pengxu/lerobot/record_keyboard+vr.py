...
class VuerTeleop:
    ...
    def get_action(self, events):
        ...
        '''
        head_rmat, left_pose, right_pose, left_qpos, right_qpos,right_wrist_mat = self.step()
        action1 = self.robot2.get_action(events)
        ...
        action = {
            "joint_1.pos":  action1["joint_1.pos"],
            "joint_2.pos": action1["joint_2.pos"],
            "joint_3.pos": action1["joint_3.pos"],
            "joint_4.pos": action1["joint_4.pos"],
            "joint_5.pos": action1["joint_5.pos"],
            "joint_6.pos": action1["joint_6.pos"],
            "tcp_1.pos": action1["tcp_1.pos"],
            "tcp_2.pos":action1["tcp_2.pos"],
            "tcp_3.pos": action1["tcp_3.pos"],
            "tcp_4.pos": action1["tcp_4.pos"],
            "tcp_5.pos": action1["tcp_5.pos"],
            "tcp_6.pos": action1["tcp_6.pos"],
