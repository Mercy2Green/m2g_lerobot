...
class VuerTeleop:
    ...
    def get_action(self, events, old_control):
        ...
        new_tcp_pose[1] = tcp_pose[1] - (right_pose[1] - self.old_pose[1]) * 1
        new_tcp_pose[2] = tcp_pose[2] + (right_pose[2] - self.old_pose[2]) * 1
        for i in range(3):
        ...
        if events["control"][6] >= 1:
            ...
            events["control"][7] = 0  
        hand_pose = [1000, 1000, 1000, 1000, 1000, 1000]            
...
def record_loop(
    ...
    while timestamp < control_time_s:
        ...
        if policy is not None:
            ...
            action = teleop.get_action(events,old_control)
